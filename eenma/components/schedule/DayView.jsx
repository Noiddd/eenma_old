...
export default function DayView() {
  ...
  return (
    <div className="py-8 isolate flex flex-auto overflow-hidden bg-white h-[95%] dark:bg-background">
      <div ref={container} className="flex flex-auto flex-col overflow-auto">
        <div className="flex w-full flex-auto">
          <div className="w-14 flex-none bg-white dark:bg-background ring-1 ring-gray-100 dark:ring-gray-600" />
